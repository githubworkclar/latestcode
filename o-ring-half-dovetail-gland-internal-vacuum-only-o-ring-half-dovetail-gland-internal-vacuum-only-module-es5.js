...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["o-ring-half-dovetail-gland-internal-vacuum-only-o-ring-half-dovetail-gland-internal-vacuum-only-module"], {
  ...
  /***/
  function clientAppOringAndGlandCalcRectangularORingCalcORingHalfDovetailGlandInternalVacuumOnlyORingHalfDovetailGlandInternalVacuumOnlyRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule", function () {
    ...
    var _o_ring_half_dovetail_gland_internal_vacuum_only_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./o-ring-half-dovetail-gland-internal-vacuum-only.component */
    ...
    var routes = [{
      path: '',
      component: _o_ring_half_dovetail_gland_internal_vacuum_only_component__WEBPACK_IMPORTED_MODULE_2__["ORingHalfDovetailGlandInternalVacuumOnlyComponent"],
      pathMatch: 'full'
    }];

    var ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule = function ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule() {
      _classCallCheck(this, ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule);
    };

    ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule
    });
    ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule_Factory(t) {
        return new (t || ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule, [{
  ...
  /***/
  function clientAppOringAndGlandCalcRectangularORingCalcORingHalfDovetailGlandInternalVacuumOnlyORingHalfDovetailGlandInternalVacuumOnlyValidationServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ORingHalfDovetailGlandInternalVacuumOnlyValidationService", function () {
    ...
    var ORingHalfDovetailGlandInternalVacuumOnlyValidationService = /*#__PURE__*/function () {
      function ORingHalfDovetailGlandInternalVacuumOnlyValidationService(helperService, unitButtonService, temperatureButtonService) {
        _classCallCheck(this, ORingHalfDovetailGlandInternalVacuumOnlyValidationService);
      ...
      _createClass(ORingHalfDovetailGlandInternalVacuumOnlyValidationService, [{
        ...
        value: function topRadiiMinNonPhysicalValidation(option) {
          ...
          return function (control) {
            ...
            if (radiiRecommendedMinValues.hMin && radiiRecommendedMinValues.topRadiiMinPercent) {
              ...
              var radiiRecommendedMinValuesTopRadiiMinPercentError = Object(_shared_directives_custom_validations_comparison_validation_directive__WEBPACK_IMPORTED_MODULE_1__["largerThanValidation"])(radiiRecommendedMinValues.topRadiiMinPercent.toString(), "13", "topRadiiMin", topRadiiClientValidationTitle, topRadiiNonPhysicalValidationMessage); // if (radiiRecommendedMinValuesHMinLessThanZeroError && radiiRecommendedMinValuesTopRadiiMinPercentError) {
        ...
        value: function toleranceValidation() {
          ...
          return function (control) {
            ...
            if (glandDepthToleranceControl && glandDepthToleranceControl.value) {
              error = Object(_shared_directives_custom_validations_comparison_validation_directive__WEBPACK_IMPORTED_MODULE_1__["largerThanEqualValidation"])(glandDepthToleranceControl.value, glandDepthNominalControl.value, "glandDepthTolerance", "", msg); // glandDepthToleranceControl.setErrors(error);
            ...
            if (glandAngleToleranceControl && glandAngleToleranceControl.value) {
              error = Object(_shared_directives_custom_validations_comparison_validation_directive__WEBPACK_IMPORTED_MODULE_1__["largerThanEqualValidation"])(glandAngleToleranceControl.value, glandAngleNominalControl.value, "glandAngleTolerance", "", msg); // glandAngleToleranceControl.setErrors(error);
            ...
            if (topRadiiToleranceControl && topRadiiToleranceControl.value) {
              error = Object(_shared_directives_custom_validations_comparison_validation_directive__WEBPACK_IMPORTED_MODULE_1__["largerThanEqualValidation"])(topRadiiToleranceControl.value, topRadiiNominalControl.value, "topRadiiTolerance", "", msg); // topRadiiToleranceControl.setErrors(error);
            ...
            if (bottomRadiiToleranceControl && bottomRadiiToleranceControl.value) {
              error = Object(_shared_directives_custom_validations_comparison_validation_directive__WEBPACK_IMPORTED_MODULE_1__["largerThanEqualValidation"])(bottomRadiiToleranceControl.value, bottomRadiiNominalControl.value, "bottomRadiiTolerance", "", msg); // bottomRadiiToleranceControl.setErrors(error);
            ...
            if (gapToleranceControl.value != 0) {
              error = Object(_shared_directives_custom_validations_comparison_validation_directive__WEBPACK_IMPORTED_MODULE_1__["largerThanEqualValidation"])(gapToleranceControl.value, gapNominalControl.value, "gapTolerance", "", msg); // gapToleranceControl.setErrors(error);
            ...
            if (glandCenterlineToleranceControl && glandCenterlineToleranceControl.value) {
              error = Object(_shared_directives_custom_validations_comparison_validation_directive__WEBPACK_IMPORTED_MODULE_1__["largerThanEqualValidation"])(glandCenterlineToleranceControl.value, glandCenterlineNominalControl.value, "glandCenterlineTolerance", "", msg); // glandCenterlineToleranceControl.setErrors(error);
        ...
        value: function generateRadiiRecomendationMin(form, option) {
          ...
          if (glandDepthMin >= 0 && glandWidthMin >= 0 && topRadiiMin >= 0 && bottomRadiiMin >= 0 && glandAngleMin >= 0) {
            ...
            radiiRecomendationMinValues.wMin = glandWidthMin / 2 + glandDepthMin / Math.tan(glandAngleMin * Math.PI / 180) - bottomRadiiMin / Math.tan(glandAngleMin / 2 * Math.PI / 180); // radiiRecomendationMinValues.hMin = Math.round(glandDepthMin - (topRadiiMin + bottomRadiiMin) * (1 + Math.sin((90 - glandAngleMin) * Math.PI / 180)));
        ...
        value: function generateRadiiRecomendationMax(form, option) {
          ...
          if (glandDepthMax >= 0 && glandWidthMax >= 0 && topRadiiMax >= 0 && bottomRadiiMax >= 0 && glandAngleMax >= 0) {
            ...
            radiiRecomendationMaxValues.wMax = glandWidthMax / 2 + glandDepthMax / Math.tan(glandAngleMax * Math.PI / 180) - bottomRadiiMax / Math.tan(glandAngleMax / 2 * Math.PI / 180); // radiiRecomendationMaxValues.hMax = Math.round(glandDepthMax - (topRadiiMax + bottomRadiiMax) * (1 + Math.sin((90 - glandAngleMax) * Math.PI / 180)));
    ...
    ORingHalfDovetailGlandInternalVacuumOnlyValidationService.ɵfac = function ORingHalfDovetailGlandInternalVacuumOnlyValidationService_Factory(t) {
      return new (t || ORingHalfDovetailGlandInternalVacuumOnlyValidationService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_services_helper_service__WEBPACK_IMPORTED_MODULE_9__["HelperService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_components_unit_button_unit_button_service__WEBPACK_IMPORTED_MODULE_10__["UnitButtonService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_components_temperature_button_temperature_button_service__WEBPACK_IMPORTED_MODULE_11__["TemperatureButtonService"]));
    };

    ORingHalfDovetailGlandInternalVacuumOnlyValidationService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: ORingHalfDovetailGlandInternalVacuumOnlyValidationService,
      factory: ORingHalfDovetailGlandInternalVacuumOnlyValidationService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ORingHalfDovetailGlandInternalVacuumOnlyValidationService, [{
  ...
  /***/
  function clientAppOringAndGlandCalcRectangularORingCalcORingHalfDovetailGlandInternalVacuumOnlyORingHalfDovetailGlandInternalVacuumOnlyComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ORingHalfDovetailGlandInternalVacuumOnlyComponent", function () {
    ...
    var _o_ring_half_dovetail_gland_internal_vacuum_only_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./o-ring-half-dovetail-gland-internal-vacuum-only.service */
    ...
    var _o_ring_half_dovetail_gland_internal_vacuum_only_validation_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./o-ring-half-dovetail-gland-internal-vacuum-only-validation.service */
    "./client/app/oring-and-gland-calc/rectangular-o-ring-calc/o-ring-half-dovetail-gland-internal-vacuum-only/o-ring-half-dovetail-gland-internal-vacuum-only-validation.service.ts");
    /* harmony import */
    ...
    function ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 15);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template_form_ngSubmit_0_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionChange", function ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template_calculator_toolbar_optionChange_3_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);

          var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r3.onOptionChange($event);
        })("reset", function ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template_calculator_toolbar_reset_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);

          var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r4.onReset();
        })("print", function ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template_calculator_toolbar_print_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("formGroup", ctx_r0.halfDovetailGlandForm);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("form", ctx_r0.halfDovetailGlandForm)("isSubmitted", ctx_r0.isSubmitted)("calculatorJSON", ctx_r0.calculatorConfig)("clientErrors", ctx_r0.clientErrors)("clientWarnings", ctx_r0.clientWarnings)("serverErrors", ctx_r0.serverErrors)("serverWarnings", ctx_r0.serverWarnings);
      }
    }

    var ORingHalfDovetailGlandInternalVacuumOnlyComponent = /*#__PURE__*/function () {
      function ORingHalfDovetailGlandInternalVacuumOnlyComponent(controlBaseService, authService, rectangularORingCalcService, dynamicFormTwoColumnLayoutService, printService, unitButtonService, temperatureButtonService, oRingHalfDovetailGlandInternalVacuumOnlyService, oRingHalfDovetailGlandInternalVacuumOnlyValidationService, helperService, calculatorToolbarService) {
        ...
        _classCallCheck(this, ORingHalfDovetailGlandInternalVacuumOnlyComponent);
        ...
        this.onUnitChangeUpdateCalculator(); // temperature change perform tasks
      ...
      _createClass(ORingHalfDovetailGlandInternalVacuumOnlyComponent, [{
        ...
        value: function initializeOringConfig(oRingJsonConfig) {
          ...
          var oRingHalfDovetailGlandVacuumOnly = Object.assign({}, oRingJsonConfig.calculators[2]);
          this.calculatorConfig = oRingHalfDovetailGlandVacuumOnly; // send calculator to dynamic form service

          this.dynamicFormTwoColumnLayoutService.sendCalculator(oRingHalfDovetailGlandVacuumOnly); // create form
        ...
        value: function getControlValue(fieldName) {
          if (this.halfDovetailGlandForm && this.halfDovetailGlandForm.controls[fieldName] && this.halfDovetailGlandForm.controls[fieldName].value) {
            return (+this.halfDovetailGlandForm.controls[fieldName].value).toFixed(this.unitButtonService.getCurrentUnitValue.id === _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["Units"].MILLI_METER ? 2 : 3);
          }
        ...
        value: function onSubmit() {
          ...
          if (this.calculatorConfig.form.form_validation.includes(_shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].GLAND_ANGLE_NOMINAL_VALIDATION)) {
          ...
          if (+this.calculatorConfig.toolbarOption.value !== _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal) {
            ...
            if (this.calculatorConfig.form.form_validation.includes(_shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].GLAND_ANGLE_MIN_VALIDATION)) {
            ...
            if (this.calculatorConfig.form.form_validation.includes(_shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].GLAND_ANGLE_MAX_VALIDATION)) {
          ...
          if (this.calculatorConfig.form.form_validation.includes(_shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].O_RING_CROSS_SECTION_LESS_THAN_GLAND_DEPTH_NOMINAL_VALIDATION)) {
          ...
          this.oRingHalfDovetailGlandInternalVacuumOnlyService.createOringHalfDovetail(this.halfDovetailGlandForm, this.calculatorConfig.toolbarOption.value, this.unitButtonService.getCurrentUnitValue, this.temperatureButtonService.getCurrentTemperatureValue).subscribe(function (resp) {
            if (resp.data) {
              ...
              _this19.CalculatedData = Object.assign({}, resp.data);

              if (resp.data.error && resp.data.error.length > 0) {
                // copy the array for change detection
                _this19.serverErrors = resp.data.error.slice();
              }

              if (resp.data.warning && resp.data.warning.length > 0) {
                // copy the array for change detection
                _this19.serverWarnings = resp.data.warning.slice();
              }
              ...
              if (_shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal !== +_this19.calculatorConfig.toolbarOption.value) {
                // Bind left form data
                // loop through each form left column row
                for (var rowIndex = 0; rowIndex < _this19.calculatorConfig.form.left_column.form_layout_row.length; rowIndex++) {
                  // loop through columns
                  for (var columnIndex = 0; columnIndex < _this19.calculatorConfig.form.left_column.form_layout_row[rowIndex].form_layout_columns.length; columnIndex++) {
                    // loop through controls
                    for (var controlIndex = 0; controlIndex < _this19.calculatorConfig.form.left_column.form_layout_row[rowIndex].form_layout_columns[columnIndex].form_controls.length; controlIndex++) {
                      // get form control of JSON
                      var formControl = _this19.calculatorConfig.form.left_column.form_layout_row[rowIndex].form_layout_columns[columnIndex].form_controls[controlIndex]; // get fields key from resp data
                ...
                for (var _rowIndex = 0; _rowIndex < _this19.calculatorConfig.form.right_column.form_layout_row.length; _rowIndex++) {
                  // loop through columns
                  for (var _columnIndex = 0; _columnIndex < _this19.calculatorConfig.form.right_column.form_layout_row[_rowIndex].form_layout_columns.length; _columnIndex++) {
                    // loop through controls
                    for (var _controlIndex = 0; _controlIndex < _this19.calculatorConfig.form.right_column.form_layout_row[_rowIndex].form_layout_columns[_columnIndex].form_controls.length; _controlIndex++) {
                      // get form control of JSON
                      var _formControl = _this19.calculatorConfig.form.right_column.form_layout_row[_rowIndex].form_layout_columns[_columnIndex].form_controls[_controlIndex]; // get fields key from resp data
                      // const responseDataKeys = Object.keys(resp.data);
                      ...
                      for (var _keyIndex = 0; _keyIndex < responseDataKeys.length; _keyIndex++) {
                        if (_formControl.sub_type === _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ControlSubType"].calculated_label && responseDataKeys[_keyIndex] === _formControl.key) {
                          // set JSON output label
                          // bind calculated result to output label
                          _this19.calculatorConfig.form.right_column.form_layout_row[_rowIndex].form_layout_columns[_columnIndex].form_controls[_controlIndex].label = resp.data[responseDataKeys[_keyIndex]] ? resp.data[responseDataKeys[_keyIndex]].toFixed(_this19.unitButtonService.getCurrentUnitValue.id === _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["Units"].INCH ? 3 : 2) : resp.data[responseDataKeys[_keyIndex]];
                        }
                      }
                    }
                  }
              ...
              for (var outputIndex = 0; outputIndex < _this19.calculatorConfig.form_output.length; outputIndex++) {
                // set output title of operating temperature label
                if (outputIndex > 0) {
                  var temperatureCode = +_this19.temperatureButtonService.getCurrentTemperatureValue.id === _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["Temperature"].FAHRENHEIT ? _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["TemperatureFahrenheitCode"].HEXA_DECIMAL_CODE : _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["TemperatureCelsiusCode"].HEXA_DECIMAL_CODE;
                  var operatingTemperatureMin = _this19.halfDovetailGlandForm.controls["operatingTemperatureMin"];
                  var operatingTemperatureNominal = _this19.halfDovetailGlandForm.controls["operatingTemperatureNominal"];
                  var operatingTemperatureMax = _this19.halfDovetailGlandForm.controls["operatingTemperatureMax"]; // operating temperature min

                  if (outputIndex === 1 && operatingTemperatureMin && operatingTemperatureMin.value) {
                    _this19.calculatorConfig.form_output[outputIndex].show = true;
                    _this19.calculatorConfig.form_output[outputIndex].display_output_title = "".concat(operatingTemperatureMin.value).concat(temperatureCode);
                  } else if (outputIndex === 1) {
                    _this19.calculatorConfig.form_output[outputIndex].show = false;
                  } // operating temperature nominal


                  if (outputIndex === 2 && operatingTemperatureNominal && operatingTemperatureNominal.value) {
                    _this19.calculatorConfig.form_output[outputIndex].show = true;
                    _this19.calculatorConfig.form_output[outputIndex].display_output_title = "".concat(operatingTemperatureNominal.value).concat(temperatureCode);
                  ...
                  if (outputIndex === 3 && operatingTemperatureMax && operatingTemperatureMax.value) {
                    _this19.calculatorConfig.form_output[outputIndex].show = true;
                    _this19.calculatorConfig.form_output[outputIndex].display_output_title = "".concat(operatingTemperatureMax.value).concat(temperatureCode);
                ...
                for (var _rowIndex2 = 0; _rowIndex2 < _this19.calculatorConfig.form_output[outputIndex].row.length; _rowIndex2++) {
                  // loop through columns
                  for (var _columnIndex2 = 0; _columnIndex2 < _this19.calculatorConfig.form_output[outputIndex].row[_rowIndex2].form_layout_columns.length; _columnIndex2++) {
                    // loop through controls
                    for (var _controlIndex2 = 0; _controlIndex2 < _this19.calculatorConfig.form_output[outputIndex].row[_rowIndex2].form_layout_columns[_columnIndex2].form_controls.length; _controlIndex2++) {
                      // get form control of JSON
                      var _formControl2 = _this19.calculatorConfig.form_output[outputIndex].row[_rowIndex2].form_layout_columns[_columnIndex2].form_controls[_controlIndex2]; // get fields key from resp data
                      // const responseDataKeys = Object.keys(resp.data);
            ...
            // reset auth token 
            _this19.setAuth(); // TODO: show error if any
          ...
          this.unitChangeSubscription = this.unitButtonService.unit$.subscribe(function (x) {
            if (x) {
              if (x.id === _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["Units"].MILLI_METER) {
                // millimeter
                _this20.bottomRadiiMaxLimit = 0.89; //0.035 * 25.40;
              } else {
                // Inch
                _this20.bottomRadiiMaxLimit = 0.035;
              } // convert the form data


              var convertedForm = _this20.helperService.convertFormUnitControlValuesAndSet(_this20.calculatorConfig && _this20.calculatorConfig.form ? _this20.calculatorConfig.form : null, _this20.halfDovetailGlandForm, x);

              if (convertedForm) {
                _this20.halfDovetailGlandForm = convertedForm;
        ...
        value: function createForm() {
          ...
          var leftFormControls = this.calculatorConfig.form.left_column.form_layout_row.map(function (row) {
            return row.form_layout_columns.map(function (column) {
              ...
              for (var index = 0; index < column.form_controls.length; index++) {
                ...
                if (_this21.halfDovetailGlandForm) {
                  var fc = _this21.halfDovetailGlandForm.get(column.form_controls[index].key);
          ...
          var filteredControls = this.flattenedFormControls.filter(function (fc) {
            ...
            if (fc && fc.type !== _this21.controlType.label && fc.type !== _this21.controlType.button) {
              return fc;
            }
          });
          this.halfDovetailGlandForm = this.controlBaseService.toFormGroup(filteredControls); // get and set validations
          ...
          for (var index = 0; index < jsonConfigValidationsArray.length; index++) {
            ...
            switch (validationFuncKey) {
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].GLAND_WIDTH_NOMINAL_VALIDATION:
                validations.push(this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService.glandWidthNominalValidation());
                break;

              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].GLAND_WIDTH_MIN_VALIDATION:
                if (+this.calculatorConfig.toolbarOption.value !== _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal) {
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].GLAND_WIDTH_MAX_VALIDATION:
                if (+this.calculatorConfig.toolbarOption.value !== _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal) {
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].BOTTOM_RADII_NOMINAL_LARGER_THAN_BOTTOM_RADII_MIN_LIMIT:
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].BOTTOM_RADII_NOMINAL_NON_PHYSICAL_GLAND_VALIDATION:
                validations.push(this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService.bottomRadiiNominalNonPhysicalGland());
                break;

              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].BOTTOM_RADII_MIN_NON_PHYSICAL_GLAND_VALIDATION:
                if (+this.calculatorConfig.toolbarOption.value !== _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal) {
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].BOTTOM_RADII_MAX_NON_PHYSICAL_GLAND_VALIDATION:
                if (+this.calculatorConfig.toolbarOption.value !== _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal) {
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].TOP_RADII_NOMINAL_LARGER_THAN_BOTTOM_RADII_MIN_LIMIT:
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].TOP_RADII_NOMINAL_NON_PHYSICAL_GLAND_VALIDATION:
                validations.push(this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService.topRadiiNominalNonPhysicalValidation());
                break;

              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].TOP_RADII_MIN_NON_PHYSICAL_GLAND_VALIDATION:
                if (+this.calculatorConfig.toolbarOption.value !== _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal) {
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].TOP_RADII_MAX_NON_PHYSICAL_GLAND_VALIDATION:
                if (+this.calculatorConfig.toolbarOption.value !== _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal) {
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].OPERATING_TEMPERATURE_VALIDATION:
                validations.push(this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService.operatingTemperatureValidation());
                break;

              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].O_RING_CROSS_SECTION_NOMINAL_STADARD_AS568A_VALIDATION:
                validations.push(this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService.oringCrossSectionNominalValidation());
                break;

              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].O_RING_ID_NOMINAL_SHOULD_BE_LESS_THAN_MAX_ORING_ID_VALUE_VALIDATION:
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].LESS_THAN_ZERO_VALIDATION:
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].TOLERANCE_VALIDATION:
              ...
              case _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].ORING_ID_AS568A_STANDARD_WARNING:
        ...
        value: function onReset() {
          ...
          var formControlKeys = Object.keys(this.halfDovetailGlandForm.controls); // loop through the reactive form/formgroup controls 
        ...
        value: function resetFormAndCalculation() {
          ...
          this.clientWarnings = [];
          this.serverErrors = [];
          this.serverWarnings = []; // if (!this.CalculatedData) { return; }
        ...
        value: function onPaste(calculatedData) {
          if (calculatedData) {
            this.halfDovetailGlandForm.patchValue(calculatedData); // set material choice dropdown value
    ...
    ORingHalfDovetailGlandInternalVacuumOnlyComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ORingHalfDovetailGlandInternalVacuumOnlyComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template, 6, 17, "form", 2);
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.calculatorConfig && ctx.halfDovetailGlandForm);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ORingHalfDovetailGlandInternalVacuumOnlyComponent, [{
        ...
        return [{
          ...
          type: _o_ring_half_dovetail_gland_internal_vacuum_only_service__WEBPACK_IMPORTED_MODULE_10__["ORingHalfDovetailGlandInternalVacuumOnlyService"]
        }, {
          type: _o_ring_half_dovetail_gland_internal_vacuum_only_validation_service__WEBPACK_IMPORTED_MODULE_11__["ORingHalfDovetailGlandInternalVacuumOnlyValidationService"]
        }, {
  ...
  /***/
  function clientAppOringAndGlandCalcRectangularORingCalcORingHalfDovetailGlandInternalVacuumOnlyORingHalfDovetailGlandInternalVacuumOnlyModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ORingHalfDovetailGlandInternalVacuumOnlyModule", function () {
    ...
    var _o_ring_half_dovetail_gland_internal_vacuum_only_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./o-ring-half-dovetail-gland-internal-vacuum-only-routing.module */
    "./client/app/oring-and-gland-calc/rectangular-o-ring-calc/o-ring-half-dovetail-gland-internal-vacuum-only/o-ring-half-dovetail-gland-internal-vacuum-only-routing.module.ts");
    /* harmony import */


    var _o_ring_half_dovetail_gland_internal_vacuum_only_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./o-ring-half-dovetail-gland-internal-vacuum-only.component */
    "./client/app/oring-and-gland-calc/rectangular-o-ring-calc/o-ring-half-dovetail-gland-internal-vacuum-only/o-ring-half-dovetail-gland-internal-vacuum-only.component.ts");
    /* harmony import */


    var _o_ring_half_dovetail_gland_internal_vacuum_only_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./o-ring-half-dovetail-gland-internal-vacuum-only.service */
    "./client/app/oring-and-gland-calc/rectangular-o-ring-calc/o-ring-half-dovetail-gland-internal-vacuum-only/o-ring-half-dovetail-gland-internal-vacuum-only.service.ts");
    /* harmony import */


    var _o_ring_half_dovetail_gland_internal_vacuum_only_validation_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./o-ring-half-dovetail-gland-internal-vacuum-only-validation.service */
    "./client/app/oring-and-gland-calc/rectangular-o-ring-calc/o-ring-half-dovetail-gland-internal-vacuum-only/o-ring-half-dovetail-gland-internal-vacuum-only-validation.service.ts"); // core improts
    // application imports


    var ORingHalfDovetailGlandInternalVacuumOnlyModule = function ORingHalfDovetailGlandInternalVacuumOnlyModule() {
      _classCallCheck(this, ORingHalfDovetailGlandInternalVacuumOnlyModule);
    };

    ORingHalfDovetailGlandInternalVacuumOnlyModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: ORingHalfDovetailGlandInternalVacuumOnlyModule
    });
    ORingHalfDovetailGlandInternalVacuumOnlyModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function ORingHalfDovetailGlandInternalVacuumOnlyModule_Factory(t) {
        return new (t || ORingHalfDovetailGlandInternalVacuumOnlyModule)();
      },
      providers: [_o_ring_half_dovetail_gland_internal_vacuum_only_service__WEBPACK_IMPORTED_MODULE_7__["ORingHalfDovetailGlandInternalVacuumOnlyService"], _o_ring_half_dovetail_gland_internal_vacuum_only_validation_service__WEBPACK_IMPORTED_MODULE_8__["ORingHalfDovetailGlandInternalVacuumOnlyValidationService"]],
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _dynamic_form_dynamic_form_module__WEBPACK_IMPORTED_MODULE_4__["DynamicFormModule"], _o_ring_half_dovetail_gland_internal_vacuum_only_routing_module__WEBPACK_IMPORTED_MODULE_5__["ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ORingHalfDovetailGlandInternalVacuumOnlyModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ORingHalfDovetailGlandInternalVacuumOnlyModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_o_ring_half_dovetail_gland_internal_vacuum_only_component__WEBPACK_IMPORTED_MODULE_6__["ORingHalfDovetailGlandInternalVacuumOnlyComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _dynamic_form_dynamic_form_module__WEBPACK_IMPORTED_MODULE_4__["DynamicFormModule"], _o_ring_half_dovetail_gland_internal_vacuum_only_routing_module__WEBPACK_IMPORTED_MODULE_5__["ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule"]],
  ...
  /***/
  function clientAppOringAndGlandCalcRectangularORingCalcORingHalfDovetailGlandInternalVacuumOnlyORingHalfDovetailGlandInternalVacuumOnlyServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ORingHalfDovetailGlandInternalVacuumOnlyService", function () {
    ...
    var _o_ring_half_dovetail_gland_internal_vacuum_only_validation_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./o-ring-half-dovetail-gland-internal-vacuum-only-validation.service */
    "./client/app/oring-and-gland-calc/rectangular-o-ring-calc/o-ring-half-dovetail-gland-internal-vacuum-only/o-ring-half-dovetail-gland-internal-vacuum-only-validation.service.ts"); // core imports
    // application imports


    var ORingHalfDovetailGlandInternalVacuumOnlyService = /*#__PURE__*/function () {
      function ORingHalfDovetailGlandInternalVacuumOnlyService(_http, oRingHalfDovetailGlandInternalVacuumOnlyValidationService) {
        _classCallCheck(this, ORingHalfDovetailGlandInternalVacuumOnlyService);
      ...
      _createClass(ORingHalfDovetailGlandInternalVacuumOnlyService, [{
        key: "createOringHalfDovetail",
        value: function createOringHalfDovetail(form, inputOption, unit, unitTemp) {
          ...
          return this._http.post("".concat(this.baseUrl, "oringglandanalysistool/createOringHalfDovetail"), body);
        }
      }]);
    ...
    ORingHalfDovetailGlandInternalVacuumOnlyService.ɵfac = function ORingHalfDovetailGlandInternalVacuumOnlyService_Factory(t) {
      return new (t || ORingHalfDovetailGlandInternalVacuumOnlyService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_o_ring_half_dovetail_gland_internal_vacuum_only_validation_service__WEBPACK_IMPORTED_MODULE_5__["ORingHalfDovetailGlandInternalVacuumOnlyValidationService"]));
    };

    ORingHalfDovetailGlandInternalVacuumOnlyService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: ORingHalfDovetailGlandInternalVacuumOnlyService,
      factory: ORingHalfDovetailGlandInternalVacuumOnlyService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ORingHalfDovetailGlandInternalVacuumOnlyService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
        ...
        return [{
          ...
          type: _o_ring_half_dovetail_gland_internal_vacuum_only_validation_service__WEBPACK_IMPORTED_MODULE_5__["ORingHalfDovetailGlandInternalVacuumOnlyValidationService"]
        }];
      }, null);
    })();
    /***/
...
//# sourceMappingURL=o-ring-half-dovetail-gland-internal-vacuum-only-o-ring-half-dovetail-gland-internal-vacuum-only-module-es5.js.map