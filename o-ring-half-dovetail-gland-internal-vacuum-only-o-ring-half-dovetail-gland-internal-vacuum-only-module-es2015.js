...
class ORingHalfDovetailGlandInternalVacuumOnlyRoutingModule {
}
...
class ORingHalfDovetailGlandInternalVacuumOnlyValidationService {
    ...
    glandWidthNominalValidation() {
        return (control) => {
            ...
            this.helperService.setValidationErrorToFormControl(glandWidthNominalControl, error, "glandWidthNominalNonPhysicalGland");
            return error;
        };
    }
...
ORingHalfDovetailGlandInternalVacuumOnlyValidationService.ɵfac = function ORingHalfDovetailGlandInternalVacuumOnlyValidationService_Factory(t) { return new (t || ORingHalfDovetailGlandInternalVacuumOnlyValidationService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_services_helper_service__WEBPACK_IMPORTED_MODULE_9__["HelperService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_components_unit_button_unit_button_service__WEBPACK_IMPORTED_MODULE_10__["UnitButtonService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_shared_components_temperature_button_temperature_button_service__WEBPACK_IMPORTED_MODULE_11__["TemperatureButtonService"])); };
ORingHalfDovetailGlandInternalVacuumOnlyValidationService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: ORingHalfDovetailGlandInternalVacuumOnlyValidationService, factory: ORingHalfDovetailGlandInternalVacuumOnlyValidationService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ORingHalfDovetailGlandInternalVacuumOnlyValidationService, [{
...
function ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("optionChange", function ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template_calculator_toolbar_optionChange_3_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2); const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.onOptionChange($event); })("reset", function ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template_calculator_toolbar_reset_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.onReset(); })("print", function ORingHalfDovetailGlandInternalVacuumOnlyComponent_form_2_Template_calculator_toolbar_print_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.onPrint(); });
...
class ORingHalfDovetailGlandInternalVacuumOnlyComponent {
    ...
    initializeOringConfig(oRingJsonConfig) {
        ...
        const oRingHalfDovetailGlandVacuumOnly = Object.assign({}, oRingJsonConfig.calculators[2]);
    ...
    onSubmit(isSubmitted = false) {
        ...
        if ((+this.calculatorConfig.toolbarOption.value) !== _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal && this.calculatorConfig.form.form_validation.includes(_shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].MIN_VALUE_RESPECT_TO_NOMINAL_VALUE_VALIDATION)) {
            ...
            const minValueErrors = this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService.minValueValidation(this.halfDovetailGlandForm, this.calculatorConfig.toolbarOption.value);
        ...
        if ((+this.calculatorConfig.toolbarOption.value) !== _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["CalculatorOption"].Nominal && this.calculatorConfig.form.form_validation.includes(_shared_helpers_constants__WEBPACK_IMPORTED_MODULE_2__["ORingTool_Half_DovetailGlandVacuumOnly_Validators"].MAX_VALUE_RESPECT_TO_NOMINAL_VALUE_VALIDATION)) {
            // apply validation only when Tolerance and min and max option selected
            const maxValueErrors = this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService.maxValueValidation(this.halfDovetailGlandForm, this.calculatorConfig.toolbarOption.value);
        ...
        // perform calculation
        this.oRingHalfDovetailGlandInternalVacuumOnlyService.createOringHalfDovetail(this.halfDovetailGlandForm, this.calculatorConfig.toolbarOption.value, this.unitButtonService.getCurrentUnitValue, this.temperatureButtonService.getCurrentTemperatureValue).subscribe((resp) => {
            if (resp.data) {
                // set CalculatedData
    ...
    createForm() {
        ...
        const leftFormControls = this.calculatorConfig.form.left_column.form_layout_row.map(row => row.form_layout_columns.map((column) => {
            ...
            for (let index = 0; index < column.form_controls.length; index++) {
                ...
                if (this.halfDovetailGlandForm) {
                    const fc = this.halfDovetailGlandForm.get(column.form_controls[index].key);
                    if (fc) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ORingHalfDovetailGlandInternalVacuumOnlyComponent, [{
...
class ORingHalfDovetailGlandInternalVacuumOnlyModule {
}
...
class ORingHalfDovetailGlandInternalVacuumOnlyService {
    constructor(_http, oRingHalfDovetailGlandInternalVacuumOnlyValidationService) {
        this._http = _http;
        this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService = oRingHalfDovetailGlandInternalVacuumOnlyValidationService;
        this.baseUrl = _app_config_service__WEBPACK_IMPORTED_MODULE_1__["AppConfig"].settings.env.api;
    }
    createOringHalfDovetail(form, inputOption, unit, unitTemp) {
        ...
        if (_shared_helpers_constants__WEBPACK_IMPORTED_MODULE_3__["CalculatorOption"].WithTolerance === +(inputOption)) {
            const minValue = this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService.generateMinValues(form);
            ...
            const maxValue = this.oRingHalfDovetailGlandInternalVacuumOnlyValidationService.generateMaxValues(form);
...
//# sourceMappingURL=o-ring-half-dovetail-gland-internal-vacuum-only-o-ring-half-dovetail-gland-internal-vacuum-only-module-es2015.js.map