...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ar-wr-calc-ar-wr-calc-module"], {
  ...
  /***/
  function clientAppArWrCalcArWrCalcRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ArWrCalcRoutingModule", function () {
    ...
    var _ar_wr_calc_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./ar-wr-calc.component */
    "./client/app/ar-wr-calc/ar-wr-calc.component.ts"); // core imports
    // application imports


    var routes = [{
      path: '',
      component: _ar_wr_calc_component__WEBPACK_IMPORTED_MODULE_3__["ArWrCalcComponent"],
      children: [{
        path: 'pressin',
        data: {
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | ar-wr-press-in-ar-wr-press-in-module */
          [__webpack_require__.e("common"), __webpack_require__.e("ar-wr-press-in-ar-wr-press-in-module")]).then(__webpack_require__.bind(null,
          /*! ./ar-wr-press-in/ar-wr-press-in.module */
          "./client/app/ar-wr-calc/ar-wr-press-in/ar-wr-press-in.module.ts")).then(function (m) {
            return m.ArWrPressInModule;
          });
        }
      }, {
        path: 'floating',
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | ar-wr-floating-ar-wr-floating-module */
          [__webpack_require__.e("common"), __webpack_require__.e("ar-wr-floating-ar-wr-floating-module")]).then(__webpack_require__.bind(null,
          /*! ./ar-wr-floating/ar-wr-floating.module */
          "./client/app/ar-wr-calc/ar-wr-floating/ar-wr-floating.module.ts")).then(function (m) {
            return m.ArWrFloatingModule;
          });
        }
      }]
    }];

    var ArWrCalcRoutingModule = function ArWrCalcRoutingModule() {
      _classCallCheck(this, ArWrCalcRoutingModule);
    };

    ArWrCalcRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: ArWrCalcRoutingModule
    });
    ArWrCalcRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function ArWrCalcRoutingModule_Factory(t) {
        return new (t || ArWrCalcRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ArWrCalcRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArWrCalcRoutingModule, [{
  ...
  /***/
  function clientAppArWrCalcArWrCalcComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ArWrCalcComponent", function () {
    ...
    var server_src_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var _shared_services_ar_wr_drop_down_data_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var _shared_components_tab_nav_tab_nav_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../shared/components/tab-nav/tab-nav.component */
    "./client/app/shared/components/tab-nav/tab-nav.component.ts");
    /* harmony import */


    var _shared_components_measure_button_measure_button_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../shared/components/measure-button/measure-button.component */
    "./client/app/shared/components/measure-button/measure-button.component.ts"); // core imports
    // application imports


    var ArWrCalcComponent = /*#__PURE__*/function () {
      function ArWrCalcComponent(arWrCalcService, router, controlBaseService, activatedRoute, arWrDropDownDataService, unitButtonService, temperatureButtonService, helperService) {
        ...
        _classCallCheck(this, ArWrCalcComponent);
        ...
        this.wrArTabs = [{
          linkLabel: "Press-In",
          rootModuleRoute: "pressin",
          childrenModuleRoute: "/wrar/pressin",
          pathExactmatch: true
        }, {
          linkLabel: "Floating",
          rootModuleRoute: "floating",
          childrenModuleRoute: "/wrar/floating",
          pathExactmatch: true
        }]; // currentSelectedCalculator: FormControlModel;

        this.defaultMeasure = null; // get route data
      ...
      _createClass(ArWrCalcComponent, [{
        key: "ngOnInit",
        ...
        value: function initializeComponent() {
          ...
          this.arWrCalcService.getArWrPressInCalcConfig().subscribe(function (resp) {
            ...
            _this2.arWrCalcService.sendArWrConfigValue(_this2.jsonConfiguration);
          }, function (error) {
        ...
        value: function getDropdownItems() {
          ...
          this.arWrDropDownDataService.getDropdownItems().subscribe(function (resp) {
            _this3.arWrDropDownDataService.sendDropdownItems(resp);
          });
        } // set initial temperature for currently selected Unit => Imperial / Metric

      }, {
        key: "setInitialTemperature",
        value: function setInitialTemperature() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArWrCalcComponent, [{
        ...
        return [{
          ...
          type: _shared_services_ar_wr_drop_down_data_service__WEBPACK_IMPORTED_MODULE_7__["ArWrDropDownDataService"]
        }, {
  ...
  /***/
  function clientAppArWrCalcArWrCalcModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ArWrCalcModule", function () {
    ...
    var _ar_wr_calc_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./ar-wr-calc-routing.module */
    "./client/app/ar-wr-calc/ar-wr-calc-routing.module.ts");
    /* harmony import */


    var _ar_wr_calc_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./ar-wr-calc.component */
    "./client/app/ar-wr-calc/ar-wr-calc.component.ts");
    /* harmony import */


    var _ar_wr_calc_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./ar-wr-calc.service */
    "./client/app/ar-wr-calc/ar-wr-calc.service.ts"); // core imports
    // o-ring tool calculators module
    // application imports


    var ArWrCalcModule = function ArWrCalcModule() {
      _classCallCheck(this, ArWrCalcModule);
    };

    ArWrCalcModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: ArWrCalcModule
    });
    ArWrCalcModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function ArWrCalcModule_Factory(t) {
        return new (t || ArWrCalcModule)();
      },
      providers: [_ar_wr_calc_service__WEBPACK_IMPORTED_MODULE_8__["ArWrCalcService"]],
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _ar_wr_calc_routing_module__WEBPACK_IMPORTED_MODULE_6__["ArWrCalcRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _dynamic_form_dynamic_form_module__WEBPACK_IMPORTED_MODULE_4__["DynamicFormModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ArWrCalcModule, {
        declarations: [_ar_wr_calc_component__WEBPACK_IMPORTED_MODULE_7__["ArWrCalcComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_5__["HeaderComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _ar_wr_calc_routing_module__WEBPACK_IMPORTED_MODULE_6__["ArWrCalcRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _dynamic_form_dynamic_form_module__WEBPACK_IMPORTED_MODULE_4__["DynamicFormModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArWrCalcModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_ar_wr_calc_component__WEBPACK_IMPORTED_MODULE_7__["ArWrCalcComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_5__["HeaderComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _ar_wr_calc_routing_module__WEBPACK_IMPORTED_MODULE_6__["ArWrCalcRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _dynamic_form_dynamic_form_module__WEBPACK_IMPORTED_MODULE_4__["DynamicFormModule"]],
  ...
  /***/
  function clientAppArWrCalcArWrCalcServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ArWrCalcService", function () {
    ...
    var _models_pressInDTO__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../models/pressInDTO */
    ...
    var _models_wrArMaterialCteDTO__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../models/wrArMaterialCteDTO */
    ...
    var _shared_services_helper_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../shared/services/helper.service */
    "./client/app/shared/services/helper.service.ts"); // core imports
    // application imports


    var ArWrCalcService = /*#__PURE__*/function () {
      /*  Constructor */
      function ArWrCalcService(_http, unitButtonService, helperService) {
        _classCallCheck(this, ArWrCalcService);
        ...
        this.oRingConfigSubject = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](null); // Expose the observable part of the arWrConfig subject (read only stream)
      ...
      _createClass(ArWrCalcService, [{
        key: "sendArWrConfigValue",
        // Methods/functions
        // send oring config
        ...
        value: function sendArWrConfigValue(val) {
          this.arWrConfig = val;
        }
        /*  Public Methods   */
        ...
        key: "getArWrPressInCalcConfig",
        value: function getArWrPressInCalcConfig() {
          return this._http.get("".concat(this.baseUrl, "wrar/getjsonconfig"));
        }
      }, {
        key: "getInterference",
        value: function getInterference(form, unit, unitTemp) {
          ...
          return this._http.post("".concat(this.baseUrl, "wrar/getInterference"), body);
        }
      }, {
        key: "getClearance",
        value: function getClearance(form, unit, unitTemp) {
          var calculatorType = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_4__["CalculatorTypes"].WrArPressIn;
          var body = new _models_pressInDTO__WEBPACK_IMPORTED_MODULE_3__["PressInDTO"](form.value);
          body.unit = unit.id.toString();
          body.unitTemp = unitTemp.id.toString();
          body.calculatorType = calculatorType;
          return this._http.post("".concat(this.baseUrl, "wrar/getClearance"), body);
        } // get material cte data

      }, {
        key: "getMaterialCTE",
        value: function getMaterialCTE(unit, material) {
          var body = new _models_wrArMaterialCteDTO__WEBPACK_IMPORTED_MODULE_5__["WrArMaterialCteDTO"]();
          body.unit = unit.id.toString();
          body.material = material;
          return this._http.post("".concat(this.baseUrl, "wrar/getCTEMaterialDetail"), body);
        } // get and set rotor and stator CTE only

      }, {
        key: "getAndSetMaterialCTE",
        value: function getAndSetMaterialCTE(form, controlKey, bindControlKey, controlValue) {
          var _this4 = this;
          ...
          this.getMaterialCTE(this.unitButtonService.getCurrentUnitValue, controlValue).subscribe(function (x) {
            ...
            if (controlKey === "rotatingMaterial") {
              form.controls[bindControlKey].setValue(_this4.helperService.convertFromNegetivePowerOfSix(x.rotorCTE).toFixed(2));
            } else if (controlKey === "stationaryMaterial") {
              // stator CTE
              form.controls[bindControlKey].setValue(_this4.helperService.convertFromNegetivePowerOfSix(x.statorCTE).toFixed(2));
            }
          });
        }
      }, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ArWrCalcService, [{
        ...
        return [{
          ...
          type: _shared_services_helper_service__WEBPACK_IMPORTED_MODULE_8__["HelperService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function clientAppArWrCalcHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function HeaderComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, " WR\xAE / AR\xAE Calculator ");
  ...
  /***/
  function clientAppModelsPressInDTOTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PressInDTO", function () {
      return PressInDTO;
    });

    var PressInDTO = function PressInDTO() {
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      _classCallCheck(this, PressInDTO);
  ...
  /***/
  function clientAppModelsWrArMaterialCteDTOTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WrArMaterialCteDTO", function () {
      return WrArMaterialCteDTO;
    });

    var WrArMaterialCteDTO = function WrArMaterialCteDTO() {
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      _classCallCheck(this, WrArMaterialCteDTO);
  ...
  /***/
  function serverSrcConstantsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WrArCalcTypes", function () {
      return WrArCalcTypes;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "customValue", function () {
      return customValue;
    });
    /* harmony export (binding) */
...
//# sourceMappingURL=ar-wr-calc-ar-wr-calc-module-es5.js.map