...
class GlandSizeRectangularGlandInternalVacuumOnlyDTO {
    constructor(options = {}) {
...
class ORingDovetailGlandVacuumOnlyDTO {
    constructor(options = {}) {
        this.unit = options.unit;
        this.unitTemp = options.unitTemp;
...
class ORingInternalVacuumOnlyDTO {
    constructor(options = {}) {
        this.unit = options.unit;
        this.unitTemp = options.unitTemp;
        this.glandWidthNominal = options.glandWidthNominal;
...
class RadiiRecomendationNominal {
    constructor() {
        this.h = 0;
        this.w = 0;
...
function lessThanValidation(val1, val2, fieldName, title, errorMessage, errorType = _helpers_constants__WEBPACK_IMPORTED_MODULE_1__["ErrorTypes"].Error) {
    if (!val1) {
        return null;
    }
...
function lessThanEqualValidation(val1, val2, fieldName, title, errorMessage, errorType = _helpers_constants__WEBPACK_IMPORTED_MODULE_1__["ErrorTypes"].Error) {
    if (!val1) {
        return null;
    }
    return val1 && val2 && (parseFloat(val1) <= parseFloat(val2)) ?
...
function largerThanValidation(val1, val2, fieldName, title, errorMessage, errorType = _helpers_constants__WEBPACK_IMPORTED_MODULE_1__["ErrorTypes"].Error) {
    if (!val1) {
        return null;
    }
    return val1 && val2 && (parseFloat(val1) > parseFloat(val2)) ?
...
// value1 should not be larger than value2
function largerThanEqualValidation(val1, val2, fieldName, title, errorMessage, errorType = _helpers_constants__WEBPACK_IMPORTED_MODULE_1__["ErrorTypes"].Error) {
    if (!val1) {
        return null;
    }
    return val1 && val2 && (parseFloat(val1) >= parseFloat(val2)) ?
...
function noLargerThanHalf(val1, val2, fieldName, title, errorMessage, errorType = _helpers_constants__WEBPACK_IMPORTED_MODULE_1__["ErrorTypes"].Error) {
    if (!val1) {
        return null;
    }
