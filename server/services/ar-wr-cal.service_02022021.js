...
let ORingGlandAnalysisService = class ORingGlandAnalysisService {
    ...
    async pressInCalculation(data) {
        try {
            ...
            const stationaryMaterialResult = await this.getMaterialDetail(data.stationaryMaterial, (+data.unit), (+data.customRotatingMaterial), (+data.customStationaryMaterial));
            ...
            const rotatingMaterialResult = await this.getMaterialDetail(data.rotatingMaterial, (+data.unit), (+data.customRotatingMaterial), (+data.customStationaryMaterial));
            // get stator value based on selected "stationary material"
            ...
            if (finishMachineCompositeIDAfterInstallationTol) {
                output.estimatingIDAfterInstallationTol = `+ ${finishMachineCompositeIDAfterInstallationTol}`;
            }
            else {
    ...
    async floatingCalculation(data) {
        try {
            ...
            if ((idCTEAtMaxTemperatureResult && idCTEAtMaxTemperatureResult.cteAtTemperature.idCTE) && (data.composite.id === 1 || data.composite.id === 2 || data.composite.id === 3)) {
                ...
                idCalcTH = eval(floatingDetails[0].idCalcTH1.formula);
                ...
                idCalcTH = eval(floatingDetails[0].idCalcTH2.formula);
            ...
            if ((idCTEAtMaxTemperatureResult && idCTEAtMaxTemperatureResult.cteAtTemperature.idCTE) && (data.composite.id === 1 || data.composite.id === 2 || data.composite.id === 3)) {
                // composite material AR®1(1) && AR®HT(2) && WR®300(3)                                
                idCalcTL = eval(floatingDetails[0].idCalcTL1.formula);
                ...
                if (cteAtTemperatureResult) {
                    ...
                    // TODO: remove
                    this.logger.info(`compositeODCTEAtMinTemp ${compositeODCTEAtMinTemp}`);
                    idCalcTL = eval(floatingDetails[0].idCalcTL2.formula);
                ...
                if (cteAtTemperatureResult) {
                    ...
                    idCalcTL = eval(floatingDetails[0].idCalcTL3.formula);
                ...
                if (data.composite.id === 1 || data.composite.id === 2 || data.composite.id === 3 || data.composite.id === 4 || data.composite.id === 6) {
                    ...
                    if ((data.serviceStorageTemperatureAmbient75FMax) > maxTempConst) {
                        ...
                        if (idCTEAtMaxTemperatureResult) {
                            cteAtTemperatureOALCTE = idCTEAtMaxTemperatureResult.cteAtTemperature.oalCTE;
                            // TODO: remove
                            this.logger.info(`cteAtTemperatureOALCTE ${cteAtTemperatureOALCTE}`);
...
//# sourceMappingURL=ar-wr-cal.service_02022021.js.map