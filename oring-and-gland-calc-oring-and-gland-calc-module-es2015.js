...
const routes = [
    {
        ...
        children: [
            { path: 'evaluateoringglands', loadChildren: () => __webpack_require__.e(/*! import() | rectangular-o-ring-calc-rectangular-o-ring-calc-module */ "rectangular-o-ring-calc-rectangular-o-ring-calc-module").then(__webpack_require__.bind(null, /*! ./rectangular-o-ring-calc/rectangular-o-ring-calc.module */ "./client/app/oring-and-gland-calc/rectangular-o-ring-calc/rectangular-o-ring-calc.module.ts")).then(m => m.RectangularORingCalcModule) },
            { path: 'evaluateglandsizecalculatorsglands', loadChildren: () => Promise.all(/*! import() | rectangle-gland-calc-rectangle-gland-calc-module */[__webpack_require__.e("common"), __webpack_require__.e("rectangle-gland-calc-rectangle-gland-calc-module")]).then(__webpack_require__.bind(null, /*! ./rectangle-gland-calc/rectangle-gland-calc.module */ "./client/app/oring-and-gland-calc/rectangle-gland-calc/rectangle-gland-calc.module.ts")).then(m => m.RectangleGlandCalcModule) }
        ]
    }
];
class ORingAndGlandCalcRoutingModule {
}
...
class OringAndGlandCalcComponent {
    constructor() {
        // tabs
        this.oRingTabs = [
...
//# sourceMappingURL=oring-and-gland-calc-oring-and-gland-calc-module-es2015.js.map