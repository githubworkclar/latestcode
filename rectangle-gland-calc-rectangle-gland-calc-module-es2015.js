...
const routes = [
    {
        path: '', component: _rectangle_gland_calc_component__WEBPACK_IMPORTED_MODULE_2__["RectangleGlandCalcComponent"], children: [
            { path: 'createRectangleGland', data: { calculatorType: _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_3__["CalculatorTypes"].ORingInternalVacuumOnly }, loadChildren: () => Promise.all(/*! import() | gland-size-rectangle-internal-vacuum-only-gland-size-rectangle-internal-vacuum-only-module */[__webpack_require__.e("common"), __webpack_require__.e("gland-size-rectangle-internal-vacuum-only-gland-size-rectangle-internal-vacuum-only-module")]).then(__webpack_require__.bind(null, /*! ./gland-size-rectangle-internal-vacuum-only/gland-size-rectangle-internal-vacuum-only.module */ "./client/app/oring-and-gland-calc/rectangle-gland-calc/gland-size-rectangle-internal-vacuum-only/gland-size-rectangle-internal-vacuum-only.module.ts")).then(m => m.GlandSizeRectangleInternalVacuumOnlyModule) },
            { path: 'createDovetailGland', data: { calculatorType: _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_3__["CalculatorTypes"].ORingDovetailGlandVacuumOnly }, loadChildren: () => Promise.all(/*! import() | gland-size-dovetail-gland-vacuum-only-gland-size-dovetail-gland-vacuum-only-module */[__webpack_require__.e("common"), __webpack_require__.e("gland-size-dovetail-gland-vacuum-only-gland-size-dovetail-gland-vacuum-only-module")]).then(__webpack_require__.bind(null, /*! ./gland-size-dovetail-gland-vacuum-only/gland-size-dovetail-gland-vacuum-only.module */ "./client/app/oring-and-gland-calc/rectangle-gland-calc/gland-size-dovetail-gland-vacuum-only/gland-size-dovetail-gland-vacuum-only.module.ts")).then(m => m.GlandSizeDovetailGlandVacuumOnlyModule) },
            { path: 'createHalfDovetailGland', data: { calculatorType: _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_3__["CalculatorTypes"].ORingHalfDovetailGlandInternalVacuumOnly }, loadChildren: () => Promise.all(/*! import() | gland-size-half-dovetail-gland-internal-vacuum-only-gland-size-half-dovetail-gland-internal-vacuum-only-module */[__webpack_require__.e("common"), __webpack_require__.e("gland-size-half-dovetail-gland-internal-vacuum-only-gland-size-half-dovetail-gland-internal-vacuum-only-module")]).then(__webpack_require__.bind(null, /*! ./gland-size-half-dovetail-gland-internal-vacuum-only/gland-size-half-dovetail-gland-internal-vacuum-only.module */ "./client/app/oring-and-gland-calc/rectangle-gland-calc/gland-size-half-dovetail-gland-internal-vacuum-only/gland-size-half-dovetail-gland-internal-vacuum-only.module.ts")).then(m => m.GlandSizeHalfDovetailGlandInternalVacuumOnlyModule) },
            { path: 'createRectangleOdGland', data: { calculatorType: _shared_helpers_constants__WEBPACK_IMPORTED_MODULE_3__["CalculatorTypes"].ORingRectangularGlandExternalVacuumOnly }, loadChildren: () => Promise.all(/*! import() | gland-size-rectangular-gland-external-vacuum-only-gland-size-rectangular-gland-external-vacuum-only-module */[__webpack_require__.e("common"), __webpack_require__.e("gland-size-rectangular-gland-external-vacuum-only-gland-size-rectangular-gland-external-vacuum-only-module")]).then(__webpack_require__.bind(null, /*! ./gland-size-rectangular-gland-external-vacuum-only/gland-size-rectangular-gland-external-vacuum-only.module */ "./client/app/oring-and-gland-calc/rectangle-gland-calc/gland-size-rectangular-gland-external-vacuum-only/gland-size-rectangular-gland-external-vacuum-only.module.ts")).then(m => m.GlandSizeRectangularGlandExternalVacuumOnlyModule) }
        ],
    }
];
class RectangleGlandCalcRoutingModule {
}
...
class RectangleGlandCalcValidationService {
...
class RectangleGlandCalcComponent {
    constructor(rectangleGlandCalcService, router, controlBaseService, activatedRoute) {
    ...
    ngOnInit() {
        ...
        this.rectangleGlandCalcService.getGlandSizeCalcConfig().subscribe((resp) => {
            this.isJSONConfigFetched = true;
            this.jsonConfiguration = resp;
            // bind calculator type ddl 
            const calculatorTypes = [...this.getCalculatorTypeArray(this.GLAND_SIZE_CALCULATOR_TYPE_FORM_CONTROL_KEY)];
    ...
    getCalculatorTypeArray(formControlKey) {
        ...
        for (let index = 0; index < this.jsonConfiguration.calculators.length; index++) {
            const fc = new _models_form_control_model__WEBPACK_IMPORTED_MODULE_4__["FormControlModel"]({ form_control_id: this.jsonConfiguration.calculators[index].id, key: formControlKey, label: this.jsonConfiguration.calculators[index].display_calculator_title, value: this.jsonConfiguration.calculators[index] });
...
RectangleGlandCalcComponent.ɵfac = function RectangleGlandCalcComponent_Factory(t) { return new (t || RectangleGlandCalcComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_rectangle_gland_calc_service__WEBPACK_IMPORTED_MODULE_5__["RectangleGlandCalcService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_shared_services_control_base_service__WEBPACK_IMPORTED_MODULE_6__["ControlBaseService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"])); };
RectangleGlandCalcComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RectangleGlandCalcComponent, selectors: [["app-rectangle-gland-calc"]], decls: 27, vars: 1, consts: [[1, "container"], [1, "row", "ignorePdf"], [1, "col-12", "col-sm-12", "col-md-9", "col-lg-9", "col-xl-9", "p-1"], [1, "row"], [1, "col-12", "col-sm-12", "col-md-12", "col-lg-12", "col-xl-12", "p-1"], [1, "info-tab", "pt-0"], ["class", "col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 p-1", 4, "ngIf"], [1, "col-12", "col-sm-12", "col-md-3", "col-lg-3", "col-xl-3", "p-1"], [1, "col-12", "col-sm-12", "col-md-12", "col-lg-12", "col-xl-12", "p-0"], [1, "col-12", "col-sm-12", "col-md-6", "col-lg-6", "col-xl-6", "p-0"], [1, "pull-left", "unit-section__label"], [1, "col-12", "col-sm-12", "col-md-5", "col-lg-5", "col-xl-5", "p-1"], [3, "options", "form", "control", "selectionChange"]], template: function RectangleGlandCalcComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RectangleGlandCalcComponent, [{
    ...
    }], function () { return [{ type: _rectangle_gland_calc_service__WEBPACK_IMPORTED_MODULE_5__["RectangleGlandCalcService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _shared_services_control_base_service__WEBPACK_IMPORTED_MODULE_6__["ControlBaseService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }]; }, null); })();
...
class RectangleGlandCalcModule {
}
...
class RectangleGlandCalcService {
    /*  Constructor */
    constructor(_http) {
        this._http = _http;
        /* Private Properties   */
    ...
    // assigning a value to this.glandSizeCalcConfig will push it onto the observable 
    // and down to all of its subsribers (ex: this.glandSizeCalcConfig = {})
    sendGlandSizeCalcConfigValue(val) {
...
//# sourceMappingURL=rectangle-gland-calc-rectangle-gland-calc-module-es2015.js.map